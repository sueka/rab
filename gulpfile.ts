...
const typeCheckForDevelopment = series(preTypeCheck, npxTask('tsc', ['--noEmit', '-p', './tsconfig.dev.json']))
...
export const buildStorybook = parallel(typeCheckForDevelopment, npxTask('build-storybook'))
